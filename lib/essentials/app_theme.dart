...
class AppTheme {
  ...
  static final Map<String, ThemeData> themes = {
    ...
    'yellowGradientLightTheme' : generateThemeData(Color.fromARGB(255, 255, 208, 0), Color.fromARGB(255, 255, 190, 51), Brightness.light, Colors.white, Color.fromARGB(255, 255, 208, 0)),
    'yellowGradientDarkTheme' : generateThemeData(Color.fromARGB(255, 255, 208, 0), Color.fromARGB(255, 255, 190, 51), Brightness.dark, Colors.white, Color.fromARGB(255, 255, 208, 0)),
