...
class AppTheme {
  ...
  static final Map<String, ThemeData> themes = {
    'pinkLightTheme': generateThemeData(Colors.purple[300], Colors.pink[300],
        Brightness.light, Colors.white, Colors.pink[300]),
    'pinkDarkTheme': generateThemeData(Colors.pink[300], Colors.pink[200],
        Brightness.dark, Colors.white, Colors.pink[200]),
    'seaBlueLightTheme': generateThemeData(Colors.blue[700], Colors.blue[900],
        Brightness.light, Colors.white, Colors.blue[900]),
    'seaBlueDarkTheme': generateThemeData(Colors.blue[400], Colors.blue[300],
        Brightness.dark, Colors.white, Colors.blue[300]),
    'greenLightTheme': generateThemeData(Colors.green, Colors.green[700],
        Brightness.light, Colors.white, Colors.green[700]),
    'greenDarkTheme': generateThemeData(Colors.green[400], Colors.green[300],
        Brightness.dark, Colors.white, Colors.green[300]),
    'amberLightTheme': generateThemeData(Colors.amber[700], Colors.amber[500],
        Brightness.light, Colors.white, Colors.amber[500]),
    'amberDarkTheme': generateThemeData(Colors.amber[600], Colors.amber[500],
        Brightness.dark, Colors.black, Colors.amber[500]),
    'roseannaGradientLightTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 255, 175, 189),
        cardColor: Color.fromARGB(255, 252, 239, 230)),
    'roseannaGradientDarkTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 255, 175, 189),
        cardColor: Color.fromARGB(255, 36, 28, 24)),
    'passionateBedGradientLightTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 255, 117, 140),
        cardColor: Color.fromARGB(255, 250, 222, 227)),
    'passionateBedGradientDarkTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 255, 117, 140),
        cardColor: Color.fromARGB(255, 26, 19, 21)),
    'plumGradientLightTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 152, 108, 240),
        cardColor: Color.fromARGB(255, 245, 237, 255)),
    'plumGradientDarkTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 152, 108, 240),
        cardColor: Color.fromARGB(255, 29, 25, 33)),
    'celestialGradientLightTheme': generateThemeData(
    ...
    'celestialGradientDarkTheme': generateThemeData(
        Color.fromARGB(255, 29, 38, 113),
        Color.fromARGB(255, 195, 55, 100),
        Brightness.dark,
        Colors.white,
    ...
    'sexyBlueGradientLightTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 33, 147, 176),
      cardColor: Color.fromARGB(255, 240, 252, 255),
    ),
    'sexyBlueGradientDarkTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 33, 147, 176),
      cardColor: Color.fromARGB(255, 19, 26, 28),
    ),
    'endlessGradientLightTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 67, 206, 162),
      cardColor: Color.fromARGB(255, 240, 255, 250),
    ),
    'endlessGradientDarkTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 67, 206, 162),
      cardColor: Color.fromARGB(255, 13, 23, 20),
    ),
    'greenGradientLightTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 24, 219, 56),
      cardColor: Color.fromARGB(255, 237, 255, 240),
    ),
    'greenGradientDarkTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 24, 219, 56),
      cardColor: Color.fromARGB(255, 12, 20, 13),
    ),
    'yellowGradientLightTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 255, 208, 0),
        cardColor: Color.fromARGB(255, 255, 246, 212)),
    'yellowGradientDarkTheme': generateThemeData(
        ...
        Colors.black,
        Color.fromARGB(255, 255, 208, 0),
        cardColor: Color.fromARGB(255, 26, 23, 15)),
    'orangeGradientLightTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 255, 153, 102),
      cardColor: Color.fromARGB(255, 255, 245, 240),
    ),
    'orangeGradientDarkTheme': generateThemeData(
      ...
      Colors.white,
      Color.fromARGB(255, 255, 153, 102),
      cardColor: Color.fromARGB(255, 23, 18, 15),
    ),
    'blackGradientLightTheme': generateThemeData(
        ...
        Colors.white,
        Color.fromARGB(255, 67, 67, 67)),
    'whiteGradientDarkTheme': generateThemeData(
  ...
  static Gradient gradientFromTheme(ThemeData theme,
  ...
  static ThemeData generateThemeData(Color primaryColor, Color secondaryColor,
      Brightness brightness, Color fontOnSecondaryColor, Color gradientColor,
      {Color secondGradientColor,
      Color thirdGradientColor,
      Color fourthGradientColor,
      Color fifthGradientColor,
      Color cardColor}) {
